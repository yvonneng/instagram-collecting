...
Plain text 
{: .label .label-blue } Captures intellectual content. Doesn't capture look and feel. 
...
Screenshot 
{: .label .label-blue} Captures intellectual content and look and feel. Doesn't capture behavior, and text can't be selected or copy/pasted.
...
Web archive 
{: .label .label-blue} Captures intellectual content, look and feel, and behavior. But it's a more complex format that's harder to use.
