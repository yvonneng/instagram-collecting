...
1. XCode - part of MacOS, but for software developers. Has stuff you need in it. 
2. Homebrew - this is a tool to help you install the other things. 
3. Python3 and pip3 - Instaloader is written in Python, so you need it. Pip is a tool for installing Python packages.
4. Instaloader ! 
